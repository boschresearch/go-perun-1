...
func toLedgerChannelProposalMsg(protoMsg *LedgerChannelProposalMsg) (msg *client.LedgerChannelProposalMsg, err error) {
...
func toBaseChannelProposal(protoProp *BaseChannelProposal) (prop client.BaseChannelProposal, err error) {
	...
	if err != nil {
		return prop, errors.WithMessage(err, "encoding init bals")
	}
	...
	if err != nil {
		return prop, errors.WithMessage(err, "encoding and and init data")
	}
