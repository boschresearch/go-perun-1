...
type (
	...
	App interface {
		...
		// NewData returns an instance of data specific to this application.
		// This has to be defined on an application-level because every app can
		// have completely different data. This instance should be used for
		// unmarshaling the binary representation of the data.
		//
	...
	ActionApp interface {
		...
		// be used for unmarshaling the binary representation of the action.
		//
		// It is zero-value is safe to use.
		NewAction() Action
	}
	...
	//
	// It is sent as binary data over the wire. For unmarshaling an action from
